...
# Add these endpoints to your user router

@router.get("/cohorts")
async def get_user_cohorts(
    current_user: dict = Depends(get_current_user)
):
    """Get cohorts the current user belongs to"""
    try:
        # This would depend on your user-cohort relationship structure
        # Example implementation:
        
        cohorts = await db.fetch_all("""
        ...
        return [{"id": cohort["id"], "name": cohort["name"]} for cohort in cohorts]
...
async def get_user_courses(
    ...
    try:
        # This would depend on your user-course relationship structure
        # Example implementation:
